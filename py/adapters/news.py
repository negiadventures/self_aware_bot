...
class WikipediaAdapter(LogicAdapter):
    ...
    def process(self, statement):
        ...
        nouns = [word for word, pos in tagged if (pos == 'NN' or pos == 'NNP' or pos == 'NNS' or pos == 'NNPS' or pos == 'VBG') ]
        ...
        if len(nouns)!=0:
            try:
                ...
                response = Statement("Sir, there seems to be more than one entries for this term in my dictionary. Try to be more specific please.")
